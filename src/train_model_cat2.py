...
if __name__ == '__main__':  
    # 1) Load dataset
    f = open("./../datasets/CPMG_G_XY_7.ds", 'rb')
    data = pickle.load(f)
    f.close()  
    ...
    # 5) Save results        
    mlmodel.save_model("trained_model_CPMG_G_XY_7_3000")
#########################################################
    
    # 1) Load dataset
    f = open("./../datasets/CPMG_G_XY_pi_7.ds", 'rb')
    data = pickle.load(f)
    f.close()  
    ...
    # 5) Save results        
    mlmodel.save_model("trained_model_CPMG_G_XY_pi_7_3000")
